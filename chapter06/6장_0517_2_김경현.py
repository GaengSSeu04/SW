...
print("text3의 인덱스 5 이후에 'o'가 몇 개 있나요? ", text3.count('o',5))
...
# 리스트 생성
list1 = ['1','2','3','4','5']
print("list1 내용에 '-'룰 결합 : ", '-'.join(list1))

list2 = [1,2,3,4,5]
# 오류 발생. 정수와 문자는 연결이 안됨. join()의 대상은 반드시 문자열이어야 함.
#print("list1 내용에 '-'룰 결합 : ", '-'.join(list2))
...
text5 = '1234567890'
print("text의 문자열이 모두 숫자로 구성되어 있는가?", text5.isdigit())
